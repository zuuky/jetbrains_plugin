...
fun getCurrentOpenVirtualFile(project: Project): VirtualFile? =
    FileEditorManager.getInstance(project).selectedFiles.firstOrNull()

fun getCurrentOpenRelativeFilePath(project: Project): String? =
    relativePath(project, getCurrentOpenVirtualFile(project))
 ...
 * 有效模式 = 用户配置的排除模式 + 项目 .gitignore 模式（自动并入），支持文件与文件夹匹配。
 *
